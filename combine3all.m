...
%    2) load year = 2012
%    3) load scaling: original_annual_load = 4235, target_annual_load = 7000
%    4) load data read as Load_kWh and Pload_kW
%    5) wind is NOT multiplied by 2
%    6) PV is multiplied by 0.25
%
%  Note:
...
%  User settings
%% ---------------------------
targetLCLid = 'MAC000022';
target_year_load = 2012;
...
Soc_init_kWh = SOC_init_pu * Ubat;
Soc_min_kWh  = SOC_min_pu  * Ubat;
Soc_max_kWh  = SOC_max_pu  * Ubat;
...
try
    P_pv = readtable('ninja.xlsx', ...
        'Sheet', 'ninja_pv_53.4795_-2.2451_correc', ...
        'Range', 'A4:C8764', ...
        'VariableNamingRule','preserve');
catch
